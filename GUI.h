...
class GUI_MainFrame : public wxFrame 
{
	...
	public:
		...
		GUI_MainFrame( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Team Gateway - GUI CPU Simulator"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 1000,700 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
		~GUI_MainFrame();
