...
{
	this->SetSizeHints( wxSize( 860,710 ), wxSize( -1,-1 ) );
	...
	m_listBox21 = new wxListBox( this, wxID_ANY, wxDefaultPosition, wxSize( 280,100 ), 0, NULL, wxLB_ALWAYS_SB ); 
	...
	m_listBox4 = new wxListBox( this, wxID_ANY, wxDefaultPosition, wxSize( 280,100 ), 0, NULL, wxLB_ALWAYS_SB ); 
	...
	m_listBox2 = new wxListBox( this, wxID_ANY, wxDefaultPosition, wxSize( 280,100 ), 0, NULL, wxLB_ALWAYS_SB ); 
	bSizer10->Add( m_listBox2, 0, 0, 5 );
	...
	bSizer2713 = new wxBoxSizer( wxHORIZONTAL );
	
	wxBoxSizer* bSizer29;
	bSizer29 = new wxBoxSizer( wxVERTICAL );
	
	bSizer29->SetMinSize( wxSize( 200,-1 ) ); 
	bSizer2713->Add( bSizer29, 0, 0, 5 );
	
	m_animCtrl1 = new wxAnimationCtrl( this, wxID_ANY, wxNullAnimation, wxDefaultPosition, wxSize( 400,50 ), wxAC_DEFAULT_STYLE ); 
	bSizer2713->Add( m_animCtrl1, 1, 0, 5 );
	...
	sbSizer5 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, wxT("CPU Initialization") ), wxVERTICAL );
	...
	bSizer27->Add( sbSizer5, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );
	...
	m_listBox42 = new wxListBox( this, wxID_ANY, wxDefaultPosition, wxSize( 270,-1 ), 0, NULL, wxLB_ALWAYS_SB ); 
	bSizer81->Add( m_listBox42, 1, wxEXPAND, 5 );
	
	m_listBox421 = new wxListBox( this, wxID_ANY, wxDefaultPosition, wxSize( 80,-1 ), 0, NULL, wxLB_ALWAYS_SB );
	m_listBox421->Append( wxT("PC:") );
	bSizer81->Add( m_listBox421, 0, wxEXPAND, 5 );
	...
	bSizer111->Add( m_button62, 0, 0, 5 );
	
	sbSizer41->Add( bSizer111, 0, 0, 5 );
	
	bSizer27->Add( sbSizer41, 0, wxEXPAND, 5 );
	
	bSizer121->Add( bSizer27, 0, wxEXPAND, 5 );
	
	wxBoxSizer* bSizer271;
	bSizer271 = new wxBoxSizer( wxVERTICAL );
	
	bSizer271->SetMinSize( wxSize( 100,-1 ) ); 
	m_animCtrl2 = new wxAnimationCtrl( this, wxID_ANY, wxNullAnimation, wxDefaultPosition, wxSize( 50,50 ), wxAC_DEFAULT_STYLE ); 
	bSizer271->Add( m_animCtrl2, 0, 0, 5 );
	
	bSizer121->Add( bSizer271, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_listBox3 = new wxListBox( this, wxID_ANY, wxDefaultPosition, wxSize( 270,120 ), 0, NULL, wxLB_ALWAYS_SB ); 
	bSizer9->Add( m_listBox3, 0, wxEXPAND, 5 );
	...
	m_listBox41 = new wxListBox( this, wxID_ANY, wxDefaultPosition, wxSize( 500,150 ), 0, NULL, wxLB_ALWAYS_SB|wxLB_NEEDED_SB|wxLB_SINGLE|wxVSCROLL ); 
	...
	m_listBox8 = new wxListBox( this, wxID_ANY, wxDefaultPosition, wxSize( 340,130 ), 0, NULL, wxLB_ALWAYS_SB ); 
	bSizer24->Add( m_listBox8, 1, wxALL|wxEXPAND, 5 );
	
	sbSizer6->Add( bSizer24, 0, 0, 5 );
	
	bSizer2->Add( sbSizer6, 0, 0, 5 );
	...
	m_button1->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GUI_MainFrame::OnDataOpen ), NULL, this );
	...
	m_button12->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GUI_MainFrame::OnResume ), NULL, this );
	...
	m_button3->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GUI_MainFrame::OnImOpen ), NULL, this );
...
GUI_MainFrame::~GUI_MainFrame()
{
	...
	m_button1->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GUI_MainFrame::OnDataOpen ), NULL, this );
	...
	m_button12->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GUI_MainFrame::OnResume ), NULL, this );
	...
	m_button3->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GUI_MainFrame::OnImOpen ), NULL, this );
